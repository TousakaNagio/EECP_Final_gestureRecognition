...
while True:
    ...
    if interrupt & 0xFF == ord('l'): # lower set_value quality
      set_value = set_value - 5
    elif interrupt & 0xFF == ord ('c'): #THRESH_BINARY TO THRESH_BINARY_INV
    ...
    elif interrupt & 0xFF == ord('u'): # upper set_value quality
      set_value = set_value + 5
